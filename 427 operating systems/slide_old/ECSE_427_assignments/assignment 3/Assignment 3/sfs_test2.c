 ...
 */
#define MAX_FNAME_LENGTH 59   /* Assume at most 20 characters (16.3) */ //59 here
 ...
 * reduce this value.
 */
#define MAX_BYTES 274432 /* Maximum file size I'll try to create */
#define MIN_BYTES 1         /* Minimum file size */
